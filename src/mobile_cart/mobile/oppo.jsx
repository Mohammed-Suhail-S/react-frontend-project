...
export default function Oppo() {
    ...
    useEffect(() => {
        ...
        .then((res) => {
            const oppoMobiles = res.data.filter(mobiles => mobiles.category === 'oppo');
            console.log(oppoMobiles);
            setMobile(oppoMobiles);
        })
        .catch((err) => {
            console.log(err);
        })
    ...
    return (
        ...
        <section className = "mobile_section">
            ...
            <div className = "mobile_container">
                <p className = "heading">Oppo Mobile Collections</p>
            </div>
