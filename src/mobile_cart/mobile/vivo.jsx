...
export default function Vivo() {
    ...
    useEffect(() => {
        ...
        .then((res) => {
            const vivoMobiles = res.data.filter(mobiles => mobiles.category === 'vivo');
            console.log(vivoMobiles);
            setMobile(vivoMobiles);
        })
        .catch((err) => {
            console.log(err);
        })
    ...
    return (
        ...
        <section className = "mobile_section">
            ...
            <div className = "mobile_container">
                <p className = "heading">Vivo Mobile Collections</p>
            </div>
            ...
            <div className = "cart_section">
                <h3>Cart List</h3>
                <button className = "cart_check" onClick = {handleCheckout}>Checkout</button><br />
                { cart.length > 0 ? (
                    cart.map((item, index) => (
